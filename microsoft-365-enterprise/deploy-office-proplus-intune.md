...
[Choose applications to deploy](./media/Configure-App-Suite-1024x858.png)
...
[Configure application suite information](App-Suite-Informaiton-1024x858.png)

3. Finally, configure a few installation settings, such as system architecture or update channel.

[Configure installation settings](App-Suite-Settings-1024x858.png)
...
## Learn more
For detailed step-by-step instructions, see [Office 365 apps for Windows 10](https://docs.microsoft.com/intune/apps-add-office365).