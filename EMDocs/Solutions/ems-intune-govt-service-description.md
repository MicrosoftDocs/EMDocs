...
- **Feature variations in Intune GCC High and DoD**
  ...
  - Intune for GCC High and DoD customers only supports standalone deployments. It does not support hybrid setup with Microsoft Endpoint Configuration Manager. 
