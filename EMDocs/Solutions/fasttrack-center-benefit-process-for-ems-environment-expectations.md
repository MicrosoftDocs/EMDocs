...
|Windows Autopilot|IT admins are responsible for registering their devices to their organization by either having the hardware vendor uploading their hardware IDs on their behalf or by uploading it themselves into the Windows Autopilot service<br /><br />**Note**: The FastTrack service benefit doesn't provide assistance on the "Rip and Reuse" scenario (Autopilot reset).|
