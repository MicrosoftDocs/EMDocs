...
6. If you are using these apps then copy the app password provided.
7. Paste the password that was copied to the clipboard into your non-browser application.
