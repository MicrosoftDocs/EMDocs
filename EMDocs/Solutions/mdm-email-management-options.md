...
description: This article provides guidance on the existing email management options when planning and designing a Microsoft Mobile Device Management solution, using Enterprise Mobility + Security.
keywords:
author: andredm7
ms.author: andredm
manager: swadhwa
