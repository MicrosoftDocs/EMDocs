...
You've found the GitHub repository that houses the source for the main Microsoft Enterprise Mobility documentation, published to the Microsoft Enterprise Mobility (EM) Documentation Center at [https://docs.microsoft.com/en-us/enterprise-mobility/](https://docs.microsoft.com/en-us/enterprise-mobility/).

## Contribute to the main Enterprise Mobility documentation
...
* Participation in a [Microsoft forum](https://social.technet.microsoft.com/Forums/en-us/home) or [Stack Overflow](http://stackoverflow.com/tags) discussion.
...
The main articles directory is found directly off the root of the repository, and contains a set of subdirectories with articles formatted as markdown files with an *.md* extension. For the Enterprise Mobility repository, this is the `\EMDocs` subdirectory. 
...
1.Clone the repository:  
    ...
    git clone https://github.com/Microsoft/EMDocs.git
